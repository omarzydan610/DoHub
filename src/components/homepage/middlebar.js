...
function MiddleBar() {
    ...
    const toggleCompletion = (id) => {
        const task = uncompletedTasks.find(task => task.id === id) || completedTasks.find(task => task.id === id);
    ...
    return (
        <div className="middle-bar w-2/5 p-4 h-full overflow-auto custom-scrollbar">
            <div className="task-form-section mb-6">
                <form id="taskForm" className="flex items-center space-x-2 mb-2" onSubmit={console.log("added")}>
                    <input 
                        type="text" 
                        value={newTaskName}
                    ...
                    <input 
                        ...
                        className="border border-gray-300 p-2 rounded w-1/3 h-10"
                    />
                    <button 
                        type="submit" 
                        id="addTask" 
            ...
            <ul id="uncompletedTaskList" className="task-list mb-6 space-y-2 mt-4 mx-2">
