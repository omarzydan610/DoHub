...
export default function TagsSection({ isDarkMode }) {
  ...
  return (
    <div className={`p-8 m-6 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg transition-all duration-200`}>
      {error && (
            ...
            selectedTaskTags.map((tag) => (
              ...
              >
                ...
                <button
                  ...
                  className={`ml-2 p-1 rounded-full hover:bg-blue-400 hover:text-white transition-all duration-200 ${
